...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="pt-20 pb-12 relative overflow-hidden">
      <div
      ...
      px-6 pl-8 md:pl-16 pr-4 md:pr-8 relative z-10"
      >
        {/* Section Header */}
        <div
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Main Testimonial */}
            <div className="glass p-6 rounded-3xl md:p-8 glow-border animate-fade-in animation-delay-200">
