...
const About = () => {
  return (
    <section id="about" className="pt-18 pb-8 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-6 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-3xl md:text-3xl font-bold leading-tight animate-fade-in animation-delay-100 text-secondary-foreground">
              Building the future,
